<nav class="layout-navbar container-xxl navbar-detached navbar navbar-expand-xl align-items-center bg-navbar-theme"
    ...
    <div class="navbar-nav-right d-flex align-items-center justify-content-between flex-grow-1" id="navbar-collapse">
        ...
        <div class="d-flex align-items-center gap-2">
            <span class="fw-semibold d-none d-md-inline">Staff workspace</span>
            <span class="badge bg-label-primary d-none d-md-inline">Staff</span>
        </div>
                        ...
                        <a class="dropdown-item" href="javascript:void(0);">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-0">{{ auth()->user()->name ?? 'Staff' }}</h6>
